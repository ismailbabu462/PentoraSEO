...
export type ToolCategory = "text" | "data" | "image" | "pdf" | "calculator";
...
> = {
    text: { name: "Metin Araçları", icon: "📝", color: "category-text" },
    data: { name: "Veri Araçları", icon: "💻", color: "category-data" },
    image: { name: "Görsel Araçları", icon: "🖼️", color: "category-image" },
    pdf: { name: "PDF Araçları", icon: "📄", color: "category-pdf" },
    calculator: { name: "Hesaplayıcılar", icon: "🧮", color: "category-calculator" },
};
        ...
        faqs: [
            {
                ...
                answer:
                    "Kelime sayacı, metinlerinizdeki toplam kelime, karakter, cümle ve paragraf sayısını hesaplar. Blog yazıları, akademik ödevler ve sosyal medya paylaşımları için karakter limitlerini kontrol etmenize yardımcı olur.",
            },
            {
                question: "Boşluklu ve boşluksuz karakter sayısı arasındaki fark nedir?",
                answer:
                    "Boşluklu karakter sayısı metindeki boşlukları da dahil eder, boşluksuz ise sadece harf ve sembolleri sayar. Twitter, Instagram gibi platformlar genellikle boşluklu sayıyı kullanır.",
            },
        ],
    },
    {
        ...
        faqs: [
            {
                ...
                answer:
                    "BÜYÜK HARF, küçük harf, Başlık Formatı, cÜMLE FORMATI ve url-slug-formati desteklenmektedir.",
            },
        ],
    },
    {
        ...
        faqs: [
            {
                ...
                answer:
                    "Slug, bir web sayfasının URL'sindeki okunabilir kısımdır (örn: /blog/seo-ipuclari). SEO için önemlidir çünkü arama motorları URL'lerdeki anahtar kelimeleri değerlendirir.",
            },
            {
                question: "Türkçe karakterler neden dönüştürülüyor?",
                answer:
                    "ş, ğ, ü, ö, ç, ı gibi Türkçe karakterler bazı sistemlerde sorun çıkarabilir. Bu yüzden URL'lerde ASCII karakterlere (s, g, u, o, c, i) dönüştürülür.",
            },
        ],
    },
    {
        ...
        faqs: [
            {
                ...
                answer:
                    "Diff aracı iki metin arasındaki farkları tespit eder. Eklenen satırlar yeşil, silinen satırlar kırmızı olarak gösterilir. Kod versiyonları, doküman revizyonları ve çeviri kontrolü için kullanılır.",
            },
        ],
    },
    {
        ...
        faqs: [
            {
                ...
                answer:
                    "Regex (Regular Expression), metin içinde kalıp aramak için kullanılan bir dildir. Email doğrulama, telefon numarası bulma gibi işlemler için kullanılır.",
            },
            {
                question: "Hangi regex flag'leri destekleniyor?",
                answer:
                    "g (global), i (case-insensitive), m (multiline), s (dotAll), u (unicode) flag'leri desteklenmektedir.",
            },
        ],
    },
        ...
        faqs: [
            {
                question: "JSON nedir?",
                answer:
                    "JSON (JavaScript Object Notation), veri alışverişi için kullanılan hafif bir format. API'ler, konfigürasyon dosyaları ve veri depolama için yaygın olarak kullanılır.",
            },
            {
                question: "JSON doğrulama neden önemlidir?",
                answer:
                    "Hatalı JSON, uygulamaların çökmesine neden olabilir. Doğrulayıcı, eksik virgül, tırnak veya parantez gibi hataları tespit eder.",
            },
        ],
    },
    {
        ...
        faqs: [
            {
                ...
                answer:
                    "Base64, binary verileri ASCII karakterlere dönüştüren bir encoding yöntemi. Email ekleri, CSS'te gömülü resimler ve API'lerde veri transferi için kullanılır.",
            },
        ],
    },
    {
        ...
        faqs: [
            {
                ...
                answer:
                    "UUID (Universally Unique Identifier), 128-bit benzersiz bir tanımlayıcıdır. Veritabanı kayıtları, API kaynakları ve dağıtık sistemlerde benzersiz ID'ler için kullanılır.",
            },
            {
                question: "UUID v4 nasıl oluşturulur?",
                answer:
                    "UUID v4, rastgele sayılar kullanılarak oluşturulur. Çakışma olasılığı astronomik olarak düşüktür (2^122'de 1).",
            },
        ],
    },
    {
        ...
        faqs: [
            {
                question: "Hash nedir?",
                answer:
                    "Hash, herhangi bir veriden sabit uzunlukta benzersiz bir değer üreten tek yönlü bir fonksiyondur. Aynı giriş her zaman aynı çıkışı verir ama tersine dönüştürülemez.",
            },
            {
                question: "Hangi hash algoritmasını kullanmalıyım?",
                answer:
                    "MD5 ve SHA-1 artık güvenli kabul edilmiyor. Güvenlik gerektiren işlemler için SHA-256 veya daha güçlü algoritmalar tercih edilmeli.",
            },
        ],
    },
        ...
        faqs: [
            {
                ...
                answer:
                    "Hayır! Tüm işlemler tarayıcınızda gerçekleşir. Görselleriniz bilgisayarınızdan asla çıkmaz, tam gizlilik sağlanır.",
            },
            {
                question: "Sıkıştırma kaliteyi düşürür mü?",
                answer:
                    "Akıllı algoritmalar kullanarak görünür kalite kaybı olmadan dosya boyutunu %50-80 oranında azaltabilirsiniz.",
            },
        ],
    },
    {
        ...
        faqs: [
            {
                ...
                answer:
                    "JPEG: Fotoğraflar için, PNG: Şeffaflık gereken görseller için, WebP: Modern tarayıcılarda en iyi sıkıştırma için.",
            },
        ],
    },
        ...
        faqs: [
            {
                ...
                answer:
                    "Tarayıcı bellek sınırları dahilinde istediğiniz kadar PDF birleştirebilirsiniz. Pratik kullanımda 50+ dosya sorunsuz çalışır.",
            },
            {
                question: "Birleştirme sırası değiştirilebilir mi?",
                answer:
                    "Evet! Dosyaları sürükle-bırak ile istediğiniz sıraya getirebilirsiniz.",
            },
        ],
    },
    {
        ...
        faqs: [
            {
                ...
                answer:
                    "1-5 (1'den 5'e), 1,3,5 (sadece belirtilen sayfalar), 1-3,7,9-12 (karma) formatlarını kullanabilirsiniz.",
            },
        ],
    },
        ...
        faqs: [
            {
                ...
                answer:
                    "Türkiye'de temel ürünler için %1, bazı ürünler için %10 ve genel oran olarak %20 KDV uygulanmaktadır.",
            },
        ],
    },
    {
        ...
        faqs: [
            {
                ...
                answer:
                    "SGK işçi payı (%14), işsizlik sigortası (%1), gelir vergisi (kümülatif) ve damga vergisi (%0.759) dahildir.",
            },
        ],
    },
];
...
/**
 * Get all unique categories with their tools count
 */
export function getCategoriesWithCount(): { category: ToolCategory; count: number }[] {
